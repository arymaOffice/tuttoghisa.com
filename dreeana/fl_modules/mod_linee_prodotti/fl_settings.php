<?php 
	...
	$ordine_mod = array("categoria_prodotto ASC"); // Tipologie di ordinamento disponobili 
	$ordine = $ordine_mod[0];
    ...
    $categoria_prodotto = $data_set->data_retriever('fl_cat_prodotti','label','WHERE id > 1 AND parent_id > 1','label ASC');
